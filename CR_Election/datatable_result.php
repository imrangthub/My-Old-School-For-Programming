...
<body>
<?php
echo '<div class="alert alert-info">'."<strong>"."Information ! Details result will be published on ".'<a class="btn-danger" style="margin-left:10px;padding:10px;" href="#">'."20 th August 2015"."</a>"."</strong>"."</div>";
?>
<?php
